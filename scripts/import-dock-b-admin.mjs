...
// Run with: node --experimental-vm-modules scripts/import-dock-b-admin.mjs
// OR from the functions dir: node ../scripts/import-dock-b-admin.mjs
//
// Uses Firebase Admin SDK with Application Default Credentials.
// Make sure you are logged in: firebase login
// Set the project: firebase use stegerholmenshamn (or set GOOGLE_CLOUD_PROJECT env)
//
// Notes:
//  - Berths 17 and 20 are shared by adjacent berths and are NOT imported
//  - Some berths have two tenants (e.g. "Peter Andersson/Peter Eriksson") — stored in comment
//  - Width and length are in centimeters
...
const berths = [
  ...
  // Berth 17 omitted — shared between berths 16 and 18
  {
    num: 18,
    widthCm: 220,
    lengthCm: 600,
  ...
  // Berth 20 omitted — shared between berths 19 and 21
  {
    num: 21,
    widthCm: 200,
    lengthCm: 580,
